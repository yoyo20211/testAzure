...
body {
  foo: rgba(100,50,10,0.5);
  foo: rgba(100,alpha: 0.5, 50,10);
  foo: rgba(alpha: 0.5, 100, 50,10);
  foo: rgba(alpha: 0.5, green: 50, red: 100, 10);
  foo: rgba(alpha: 0.5, green: 50, red: 100, blue: 10);
}