...
<td class="code">
<pre><code><span class="keyword">var</span> <span class="variable">version</span> = <span class="string">'0.6.3'</span>;</code></pre>
</td>
</tr>
<tr class="code">
<td class="docs">
...
<tr class="code">
<td class="docs">
<p>Number of test files run
 </p>
</td>
<td class="code">
<pre><code><span class="keyword">var</span> <span class="variable">testFilesRun</span> = <span class="number integer">0</span>;</code></pre>
</td>
</tr>
<tr class="code">
<td class="docs">
<p>Number of tests remaining
 </p>
</td>
<td class="code">
<pre><code><span class="keyword">var</span> <span class="variable">testsRemaining</span> = <span class="number integer">0</span>;</code></pre>
</td>
</tr>
<tr class="code">
<td class="docs">
...
<pre><code><span class="keyword">function</span> <span class="variable">runFiles</span>(<span class="variable">files</span>) {
    ...
    <span class="variable">waitForExit</span>(<span class="variable">files</span>.<span class="variable">length</span>);
}</code></pre>
</td>
</tr>
<tr class="code">
...
<pre><code><span class="keyword">function</span> <span class="variable">runFile</span>(<span class="variable">file</span>, <span class="variable">fn</span>) {
    ...
    <span class="variable">testFilesRun</span>++;
}

<span class="keyword">function</span> <span class="variable">waitForExit</span>(<span class="variable">testFiles</span>){
  <span class="keyword">var</span> <span class="variable">interval</span> = <span class="variable">setInterval</span>(<span class="keyword">function</span>(){
    <span class="keyword">if</span>(<span class="variable">testFilesRun</span> == <span class="variable">testFiles</span> &<span class="variable">amp</span>;&<span class="variable">amp</span>; <span class="variable">testsRemaining</span> == <span class="number integer">0</span>){
      ...
      <span class="variable">setTimeout</span>(<span class="keyword">function</span>(){
        <span class="variable">process</span>.<span class="variable">exit</span>(<span class="variable">failures</span> ? <span class="number integer">1</span> : <span class="number integer">0</span>);
    ...
    (<span class="keyword">function</span> <span class="variable">next</span>(){
        <span class="keyword">if</span> (<span class="variable">keys</span>.<span class="variable">length</span>) {
            ...
            <span class="keyword">if</span> (<span class="variable">test</span>) {
                <span class="variable">testsRemaining</span>++;
                <span class="keyword">try</span> {
