...
<html>
  <head>
    ...
    <style>
      ...
      html {
        ...
        background-image: url(/docs/images/zappa.png);
    ...
    <script type="text/javascript">
      var _gaq = _gaq || [];
      _gaq.push(['_setAccount', 'UA-4475762-19']);
  ...
  <body>
    <div id="wrapper">
      <nav>
        <a href="/docs/crashcourse">Crash Course</a> |
        <a href="/docs/0.3-gumbo/reference">Reference</a> |
        <a href="https://github.com/mauricemach/zappa/tree/master/examples">Examples</a> |
        <a href="/docs/zappa.html">Source</a>
      </nav>
