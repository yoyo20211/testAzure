...
(function() {
  ...
  compilePath = function(source, topLevel, base) {
    return fs.stat(source, function(err, stats) {
      ...
      if ((err != null ? err.code : void 0) === 'ENOENT') {
        if (topLevel && source.slice(-7) !== '.coffee' && source.slice(-5) !== '.iced') {
  ...
  handleIcedOptions = function(o) {
    var v, val;
    if (!o.runtime && ((v = process.env.ICED_RUNTIME) != null)) o.runtime = v;
    if (((val = o.runtime) != null) && __indexOf.call(iced["const"].runtime_modes, val) < 0) {
  ...
  version = function() {
    return printLine("IcedCoffeeScript version " + CoffeeScript.VERSION);
  };
