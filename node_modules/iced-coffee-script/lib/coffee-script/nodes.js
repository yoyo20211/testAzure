...
(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.toString = function(idt, name) {
      ...
      if (this.icedFoundArguments) extras += "G";
  ...
  exports.Block = Block = (function(_super) {
    ...
    Block.prototype.compileNode = function(o) {
      var chld, code, codes, node, top, _i, _len, _ref3;
      this.tab = o.indent;
      ...
      for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
        ...
        if (node instanceof Block) {
          ...
          if (chld && chld.length) codes.push(chld);
        } else if (top) {
          node.front = true;
          code = node.compile(o);
    ...
    Block.prototype.icedAddRuntime = function(foundDefer, foundAwait) {
      return this.expressions.unshift(new IcedRuntime(foundDefer, foundAwait));
    };
  ...
  exports.Value = Value = (function(_super) {
    ...
    Value.prototype.toSlot = function(i) {
      var sufffix, suffix;
      if (this.base instanceof Obj) return this.base.toSlot(i);
      sufffix = null;
  ...
  exports.Obj = Obj = (function(_super) {
    ...
    Obj.prototype.toSlot = function(i) {
      var prop, _i, _len, _ref3, _results;
      _ref3 = this.properties;
      _results = [];
      for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
        prop = _ref3[_i];
        if (prop instanceof Assign) {
          _results.push((prop.value.toSlot(i)).addAccess(prop.variable));
        }
      }
      return _results;
    };
  ...
  exports.Splat = Splat = (function(_super) {
    ...
    Splat.prototype.toSlot = function(i) {
    ...
    Defer.prototype.makeAssignFn = function(o) {
      ...
      for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
        ...
        if (s.splat) {
          ...
          if (s.access) a.add(new Access(s.access));
          if (!s.suffix) {
  ...
  IcedRuntime = (function(_super) {
    ...
    IcedRuntime.prototype.compileNode = function(o) {
      var access, call, callv, file, inc, lhs, ns, req, rhs, v, window_mode, window_val;
      this.expressions = [];
